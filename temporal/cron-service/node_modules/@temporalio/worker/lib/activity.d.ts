...
import { ActivityFunction, LoadedDataConverter, MetricMeter, MetricTags } from '@temporalio/common';
import { Logger } from '@temporalio/common/lib/logger';
import { coresdk } from '@temporalio/proto';
import { ActivityExecuteInput, ActivityInboundCallsInterceptor, ActivityInterceptorsFactory, ActivityOutboundCallsInterceptor } from '@temporalio/worker/lib/interceptors';
...
export declare class Activity {
    ...
    constructor(info: Info, fn: ActivityFunction<any[], any> | undefined, dataConverter: LoadedDataConverter, heartbeatCallback: Context['heartbeat'], workerLogger: Logger, workerMetricMeter: MetricMeter, interceptors: ActivityInterceptorsFactory[]);
