...
import type * as activities from '../activities/device.activities';
import { time } from 'console';

const {
  prepareData,
  checkIfEmpty,
  getShiftConfigByEmployeeId,
  getMondayShiftDetails,
  calculateLateBy,
  insertAttendance,
  // processShiftData,
  // validateDevice,
...
let finalPayload
export async function deviceWorkflow(payload: any, mode:string): Promise<void> {


  console.log("before the prepare data")
  const crtPayload: any = await prepareData(payload)
